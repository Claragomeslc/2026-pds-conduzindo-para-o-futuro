...
describe("POST /api/v1/sessions", () => {
  describe("Usuário anônimo", () => {
    test("Com `email` incorreto, mas `password` correto", async () => {
      ...
      const response = await fetch(`${webserver.origin}/api/v1/sessions`, {
        ...
        body: JSON.stringify({
          email: "email.errado@conduzindoparaofuturo.com.br",
          password: "senha-correta",
        }),
      });
    ...
    test("Com `email` correto, mas `password` incorreto", async () => {
      await orchestrator.createUser({
        email: "email.correto@conduzindoparaofuturo.com.br",
      });
    ...
    test("Com `email` incorreto e `password` incorreto", async () => {
      await orchestrator.createUser();
      ...
      const response = await fetch(`${webserver.origin}/api/v1/sessions`, {
        ...
        body: JSON.stringify({
          email: "email.incorreto@conduzindoparaofuturo.com.br",
          password: "senha-incorreta",
        }),
      });
    ...
    test("Com `email` correto e `password` correto", async () => {
      const createdUser = await orchestrator.createUser({
        email: "tudo.correto@conduzindoparaofuturo.com.br",
