...
describe("PATCH /api/v1/users/[username]", () => {
  ...
  describe("Usuário padrão", () => {
    ...
    test("Com `userB` mirando `userA`", async () => {
      await orchestrator.createUser({
        username: "userA",
      });
    ...
    test("Com `email` duplicado", async () => {
      await orchestrator.createUser({
        email: "email1@conduzindoparaofuturo.com.br",
      });

      const createdUser2 = await orchestrator.createUser({
        email: "email2@conduzindoparaofuturo.com.br",
      });
    ...
    test("Com `email` único", async () => {
      ...
      const response = await fetch(
...

        {
          ...
          body: JSON.stringify({
            email: "uniqueEmail2@conduzindoparaofuturo.com.br",
          }),
        },
      );
      ...
      expect(userInDatabase.email).toBe("uniqueEmail2@conduzindoparaofuturo.com.br");
    });

    test("Com novo `password`", async () => {
      const createdUser = await orchestrator.createUser({
  ...
  describe("Usuário privilegiado", () => {
    test("Com `update:user:others` mirando `defaultUser`", async () => {
